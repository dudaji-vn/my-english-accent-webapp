...
export default function CreatePlaylist() {
  ...
  const stepperComponent = (index: number) => {
    ...
    return (
      <Box
        className={`border-purple-200 rounded-full border border-solid p-2 h-8 w-8 flex items-center justify-center text-small-semibold ${
          activeClass ? "bg-purple-200" : ""
        }`}
      >
        {index}
      </Box>
